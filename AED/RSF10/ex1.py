...
def renderConsulta():
    ...
    img1 = customtkinter.CTkImage(Image.open(".\\AED\\RSF10\\images\\lupa.png"), size=(64, 64))
...
def treeview_sort_column(tree, col, reverse):
    """
    Função para ordenar os dados na TreeView por coluna.
    """
    # Obter os itens da TreeView e organizar os valores da coluna escolhida
    l = [(tree.set(k, col), k) for k in tree.get_children("")]
    l.sort(reverse=reverse)  # Ordenar a lista com base nos valores da coluna

    # Reordenar os itens na TreeView
    for index, (val, k) in enumerate(l):
        tree.move(k, "", index)

    # Alterar a direção de ordenação no próximo clique
...
def consultaMovimentos(cb1, cb2, utilizador, tree):  
    ...
    # como adionar headings que permitem, ordenar colunas numa tree 
    columns = ['Número', 'Data', 'Hora', 'Movimento']
    for col in columns:
...
imageIco1 = customtkinter.CTkImage(Image.open(".\\AED\\RSF10\\images\\icoOp1.png"), size=(64, 64))
...
imageIco2 = customtkinter.CTkImage(Image.open(".\\AED\\RSF10\\images\\icoOp2.png"), size=(64, 64))
...
imageIco4 = customtkinter.CTkImage(Image.open(".\\AED\\RSF10\\images\\icoOp4.png"), size=(64, 64))
...
imageLabel = customtkinter.CTkImage(Image.open(".\\AED\\RSF10\\images\\presencas.png"), size=(750, 500))
