...
signIn_button = customtkinter.CTkButton(button_frame, text="SIGN IN", fg_color="orange", width=95, height=25, border_color="gray", text_color="black", font=("Arial", 14, "bold"), command=lambda: goToRegister)
...
back_button = customtkinter.CTkButton(signIn_button_frame, text="BACK", fg_color="orange", width=95, height=25, border_color="gray", text_color="black", font=bold_font, command=lambda: showFrame(login_frame))
back_button.pack(side="right", padx=5, anchor="center")
